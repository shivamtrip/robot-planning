...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        std::cout << "Main Script Iteration: " << count << std::endl;
        ...
        targetposeX = target_traj[curr_time];
        targetposeY = target_traj[curr_time + target_steps];
        // std::cout << "X Thresh " << abs(robotposeX - targetposeX) << std::endl;
        // std::cout <<  "Y Thresh " << abs(robotposeY - targetposeY) << std::endl;
